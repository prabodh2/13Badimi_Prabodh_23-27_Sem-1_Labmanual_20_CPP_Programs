...
int main(){
    ...
    cout<<"\nQuadratice equation looks like (ax²+bx+c=0)\n";
    ...
    if (a == 0) 
    {
        if (b == 0) //if a=0, and also b=0, do...
        {
            ...
            {
                cout<< "\n\nInfinite solutions (Identity equation)" <<endl; //print this
            }
        ...
        else   //if b!=0 do the following
        {
            ...
            cout << "\n(Linear Equation) One root at 'x' = "<< x <<endl; //printing the result
        }
    }
    else //if a != 0 , do the following
    {
        d= (b*b)- 4*a*c ; //formula
        cout<< "\nDiscriminant is: "<< d<< endl; //print the value of discriminant
        ...
        if ( b == 0) //when b =0 
        {
        ...
        else if (c == 0) //when c=0
            {
                ...
                cout << "\nAnother root at x = " << (-b / a) << endl;// print this
            }
        ...
        else //when dicriminant is lesser than zero ,then...
        {
            ...
            cout << "\nComplex Roots: \nRoot 1 = " << real << " + " << imaginary << "i \nRoot 2 = " << real << " - " << imaginary << "i" << endl; //print the roots of the equation
        }
    }
